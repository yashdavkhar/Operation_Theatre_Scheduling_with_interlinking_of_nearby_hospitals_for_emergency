...
insert  into `appointment`(`username`,`emailid`,`phonenumber`,`doctor`,`specialization`,`date`,`time`,`status`,`id`,`statusbyuser`) values ('c','c@gmail.com','9029220209','n','Heart','17/2/2017','1:00 to 2:00','Pending',7,'Pending'),('c','c@gmail.com','9029220209','n','Heart','17/2/2017','2:00 to 3:00','Pending',8,'Pending'),('b','b@gm.c','8655221446','n','Heart','20/2/2017','2:00 to 3:00','Pending',9,'Pending');
...
insert  into `doctorsdetails`(`doctorname`,`specialization`,`availability`,`education`,`operation`,`about`) values ('d','s',NULL,NULL,NULL,NULL),('d','s',NULL,NULL,NULL,NULL),('d','s',NULL,NULL,NULL,NULL);
...
insert  into `hospitallist`(`hospitalname`,`location`,`machines`,`facility`,`doctors`,`staffs`,`beds`,`operations`,`lattitude`,`longitude`) values ('Fortis Hospital Mulund','Mulund Goregaon Link Rd','ventilator,robotic arm','eye specialist,dialysis','doctora,doctorb,doctorc','staffa,staffb,staffc,staffd','55','Eye specialist 2 ,kidney 2 ','18.9257751','72.793413'),('avdhut hospital','airoli','ventilator,robotic arm','eye specialist,dialysis','doctora,doctorb,doctorc','staffa,staffb,staffc,staffd','55','Eye specialist','19.157934','70.124992');
...
insert  into `multipleappointment`(`username`,`emailid`,`phonenumber`,`doctor`,`specialization`,`date`,`time`,`status`,`id`,`statusbyuser`) values (NULL,NULL,NULL,'','','31/8/2020','14:32','pending',1,'Pending'),('k',NULL,NULL,'','','31/8/2020','21:25','pending',2,'Pending'),('k',NULL,NULL,'','','1/9/2020','12:4','pending',3,'Pending'),('k',NULL,NULL,'','','3/9/2020','17:20','pending',4,'Pending'),('k',NULL,NULL,'','','2/9/2020','15:5','pending',5,'Pending');

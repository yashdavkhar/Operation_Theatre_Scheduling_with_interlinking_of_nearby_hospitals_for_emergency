...
insert  into `doctorsdetails`(`doctorname`,`specialization`) values ('d','s'),('d','s'),('d','s');
...
insert  into `hospitallist`(`hospitalname`,`location`,`operations`,`lattitude`,`longitude`) values ('h','l','o','19.236280','73.130730'),('avdhut hospital','airoli','Eye specialist','19.157934','72.993477'),('abcd','wadala','Eye specialist,kidney ','22.032650','70.124992'),('checking','wadala','Eye specialist,kidney ','19.125045','72.9515507');

...
%>
						...
						<div class="user">
							<i> </i> <input type="text" placeholder="Doctor Name" name="doctorname" required onblur="updateOutput(this.value)">
						
						</div>
						
						
						<div class="user">
							<i> </i> <input type="text" placeholder="Doctors Availibility" name="availability" required>
						</div>
						<div class="user">
							<i> </i> <input type="text" placeholder="Educational Qualification of doctor" name="education" required>
						</div>
						<div class="user">
							<i> </i> <input type="text" placeholder="Operation by doctor" name="operation" required>
						</div>
						<div class="user">
							<i> </i> <input type="text" placeholder="About doctor" name="about" required>
						</div>

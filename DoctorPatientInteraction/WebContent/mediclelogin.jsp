   	 ...
   	 <div class="block-6 signs">
   	 	<div class="block-6-left">
   	 		<div class="block-6-top">
   	 			<h6><a href="#">Already Registered?</a></h6>
   	 			<h3>Sign Up</h3>
   	 		</div>
   	 		<div class="block-6-bottom">
   	 		<form action="medicleregistartion" method="post" enctype="multipart/form-data">
   	 	...
   	 	<div class="block-right">
   	 		...
   	 		<form action="adminlogin" method="post">
						<div class="user">
							<i> </i> <input type="text" placeholder="User Name" name="username" required>
						</div>
						<div class="user1">
							<i> </i> <input type="password" placeholder="password" name="password" required>
						</div>

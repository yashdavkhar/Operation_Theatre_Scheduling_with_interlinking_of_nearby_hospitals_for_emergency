...
<!--block-5 strat here-->
		...
		<div class="block-6 signs">
   	 	<div class="block-6-left">
   	 		...
   	 		<form name=drop_list action="clinicinfodoctor" method="post">
					<input type="hidden"  name="type" value="user">
						<div class="user">
						Timing Availability <select name="timing" >
  ...
  <option value="1:00 to 2:00" selected>1:00 to 2:00</option>
  <option value="2:00 to 3:00" selected>2:00 to 3:00</option>
  <option value="3:00 to 4:00" selected>3:00 to 4:00</option>
</select>

...
<tr style="border: 1px solid black;"><td style="border: 1px solid black;" ><font color="#530179">Filename</font></td><td style="border: 1px solid black;"><font color="#530179">path</font></td></tr>
	...
	while (rs.next()) {
   	 ...
   	 <div class="block-6 signs">
				...
				<tr class="vilot-clr" style="border: 1px solid black;">
				<td class="vilot-clr" style="border: 1px solid black;">
				<lable value="<%=rs.getString("filename")%>"><font color="#530179"><%=rs.getString("filename")%></font></lable>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</td>
				<td class="vilot-clr" style="border: 1px solid black;">
				<lable value="<%=rs.getString("path")%>">
				
				<a class="vilot-clr" href="<%=rs.getString("path")%>"><font color="#530179">Download</font></a></lable>
				</td>
...
<table border="2" align="center">
 <div align="center">Prescription</div>
   <% 
	
	ResultSet rs1 = stmt
			.executeQuery("select * from userprescription where username='"+username+"'");
...
while (rs1.next()) {
   	  ...
   	  <tr style="border: 1px solid black;">
 							<td style="border: 1px solid black;"><lable
								value="<%=rs1.getString("doctor")%>"><%=rs1.getString("doctor")%></lable>
						</td>
						<td style="border: 1px solid black;"><lable
								value="<%=rs1.getString("date")%>"><%=rs1.getString("date")%></lable>
						</td>
						<td style="border: 1px solid black;"><lable value="<%=rs1.getString("medicinedetails")%>"><%=rs1.getString("medicinedetails")%></lable>
						</td>
						
						<td style="border: 1px solid black;"><lable value="<%=rs1.getString("disease")%>"><%=rs1.getString("disease")%></lable>

		...
		<div class="block-6 signs">
   	 	<div class="block-6-left">
   	 		<div class="block-6-top">
   	 			<h6><a href="#">Add  Staff Information </a></h6>
   	 			<h3>Staff Info</h3>
   	 		</div>
   	 		<div class="block-6-bottom">
   	 		<form action="insertstaffdetails" method="post" >
...
%>
						...
						<div class="user">
							<i> </i> <input type="text" placeholder="staff Name" name="doctorname" required onblur="updateOutput(this.value)">
						
						</div>
						
						
						<div class="user">
							<i> </i> <input type="text" placeholder="staff Availibility" name="availability" required>
						</div>
						<div class="user">
							<i> </i> <input type="text" placeholder="Educational Qualification of staff" name="education" required>
						</div>
						<div class="user">
							<i> </i> <input type="text" placeholder="Operation done by staff" name="operation" required>
						</div>
						<div class="user">
							<i> </i> <input type="text" placeholder="About staff" name="about" required>
						</div>

...
<!--block-5 strat here-->
				...
				<table align="center" style="border: 1px solid black;">
					...
					<%
						String user = (String) session.getAttribute("user");
							...
							ResultSet rs = stmt
									.executeQuery("select * from medicleuser");
 	...
 	<td style="border: 1px solid black;"><input type="radio" name="id" value="<%=rs.getString("username")%>"> <%=rs.getString("username")%><br>
						...
						<td style="border: 1px solid black;"><lable
								value="<%=rs.getString("emailid")%>"><%=rs.getString("emailid")%></lable>
						</td>
						   <TD><img alt="Image" src="images/<%= rs.getString("path") %>" width="160" height="160"  > </TD>

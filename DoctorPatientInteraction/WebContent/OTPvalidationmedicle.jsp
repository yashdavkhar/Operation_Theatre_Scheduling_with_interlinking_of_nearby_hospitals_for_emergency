   	 ...
   	 <div class="block-6 signs">
   	 	<div class="block-6-left">
   	 		<div class="block-6-top">
   	 			<h6><a href="#">OTP validation</a></h6>
   	 			<h3>OTP validation</h3>
   	 		</div>
   	 		<div class="block-6-bottom">
   	 		<form action="otpvalidationmedicle" method="post">
					<input type="hidden"  name="type" value="user">
						<div class="user">
							<i> </i> <input type="text" placeholder="OTP" name="OTP" required onblur="updateOutput(this.value)">

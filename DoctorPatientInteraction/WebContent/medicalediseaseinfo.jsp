		...
		<div class="block-6 signs">
   	 	<div class="block-6-left">
   	 		<div class="block-6-top">
   	 			...
   	 			<h3>Information for Disease</h3>
   	 		</div>
   	 		<div class="block-6-bottom">
   	 		<form name=drop_list action="diseaseinformation" method="post">
					<input type="hidden"  name="type" value="user">
						<div class="user">
							<i> </i> <input type="text" placeholder="disease" name="disease"  required onblur="updateOutput(this.value)">
						
						</div>
						
						<div class="user">
							<i> </i> <input type="text" placeholder="Information"  name="information" required>
						</div>
						<div class="user">
							<i> </i> <input type="text" placeholder="Medicine Details" id="medicine" name="medicinedetails"  required>
						...
						<div class="user2">
						 ...
						 <div class="user2">
						<a href="updatediseaseinfo.jsp">Click to update disease information</a>
						</div>
					</form>
   	 		 <div class="user2">

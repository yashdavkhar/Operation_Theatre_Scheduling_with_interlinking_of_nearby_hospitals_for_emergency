...
<!--part-2 start here-->
   <div class="part-2">
<!--block-5 strat here-->
   	<form action="updateprescrp" method="post">
...
String id=request.getParameter("id");
							...
							ResultSet rs = stmt
									.executeQuery("select * from userprescription where id='"
											+ id + "'");
 	...
 	<td style="border: 1px solid black;"><input type="radio" name="id" value="<%=rs.getString("id")%>"> <%=rs.getString("id")%><br>
				...
				<div class="user">
							<i> </i> <input type="text" placeholder="medicine"  style="width: 800px;"  name="medicine" value='<%=rs.getString("medicinedetails")%>' required>

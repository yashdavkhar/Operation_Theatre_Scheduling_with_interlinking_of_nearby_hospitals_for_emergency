		...
		<div class="block-6 signs">
   	 	<div class="block-6-left">
   	 		<div class="block-6-top">
   	 			...
   	 			<h3>Information for user prescription</h3>
   	 		</div>
   	 		<div class="block-6-bottom">
   	 		<form name=drop_list action="userprescription" method="post">
					<input type="hidden"  name="type" value="user">
						<div class="user">
							<i> </i> <input type="text" placeholder="username" name="username"  required onblur="updateOutput(this.value)">
						
						</div>
						
						<div class="user">
							<i> </i> <input type="text" placeholder="patient trouble"  name="patienttrouble" required>
						</div>
						<div class="user">
							<i> </i> <input type="text" placeholder="Note Details" id="medicine" name="medicine"  required>
						Meidcine  <select id="Category"  name="Category" >
 
				</select><br>
					quantity  <select id="Category1"  name="Category1" >
 
				</select><br>
					Before OR After meal  <select  id="Category2" name="Category2" >
 
				</select><br>
				
					When  <select id="Category3"  name="Category3" >
						...
						<div class="user2">
						<input type="button" value="Insert this data" onclick="myclickforaddingdata('Category','Category1','Category2','Category3');">
							<input type="submit" value="Insert Information">
						</div>
					</form>
   	 		 <div class="user2">
						<a href="viewuserprescribed.jsp">Click to update user Prescription</a>
						</div>

...
<!--part-2 start here-->
   <div class="part-2">
<!--block-5 strat here-->
   	<form action="updatepdiseseinfo" method="post">
...
String id=request.getParameter("id");
							...
							ResultSet rs = stmt
									.executeQuery("select * from mediclediseaseinfo where id='"
											+ id + "'");
 	...
 	<td style="border: 1px solid black;"><input type="radio" name="id" value="<%=rs.getString("id")%>"> <%=rs.getString("id")%><br>
						...
						<td style="border: 1px solid black;"><lable
								value="<%=rs.getString("doctor")%>"><%=rs.getString("doctor")%></lable>
						</td>
						<td style="border: 1px solid black;"><lable
								value="<%=rs.getString("information")%>"><%=rs.getString("information")%></lable>
						</td>
						<td style="border: 1px solid black;"><lable value="<%=rs.getString("medicinedetails")%>"><%=rs.getString("medicinedetails")%></lable>
						</td>
						
						<td style="border: 1px solid black;"><lable value="<%=rs.getString("disease")%>"><%=rs.getString("disease")%></lable>
				...
				<div class="user">
				information		<br>	<i> </i> <input type="text" placeholder="medicine"  style="width: 800px;"  name="information" value='<%=rs.getString("information")%>' required><br>
						
					medicinedetails<br>	<i> </i> <input type="text" placeholder="medicine"  style="width: 800px;"  name="medicinedetails" value='<%=rs.getString("medicinedetails")%>' required><br>
					disease	<br><i> </i> <input type="text" placeholder="medicine"  style="width: 800px;"  name="disease" value='<%=rs.getString("disease")%>' required><br>

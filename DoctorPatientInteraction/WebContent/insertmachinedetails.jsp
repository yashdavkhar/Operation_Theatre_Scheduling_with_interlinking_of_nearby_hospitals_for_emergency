		...
		<div class="block-6 signs">
   	 	<div class="block-6-left">
   	 		<div class="block-6-top">
   	 			<h6><a href="#">Add  Machine Information </a></h6>
   	 			<h3>Machine Info</h3>
   	 		</div>
   	 		<div class="block-6-bottom">
   	 		<form action="insertmachinedetails" method="post" >
...
%>
						...
						<div class="user">
							<i> </i> <input type="text" placeholder="Machine Name" name="doctorname" required onblur="updateOutput(this.value)">
						
						</div>
						
						
						<div class="user">
							<i> </i> <input type="text" placeholder="machine manufacturing" name="availability" required>
						</div>
						<div class="user">
							<i> </i> <input type="text" placeholder="machine expiry" name="education" required>
						</div>
						<div class="user">
							<i> </i> <input type="text" placeholder="number of operatione" name="operation" required>
						</div>
						<div class="user">
							<i> </i> <input type="text" placeholder="Doctor names who Handles" name="doctorhandling" required>
						</div>
						<div class="user">
							<i> </i> <input type="text" placeholder="About machine" name="about" required>
						</div>

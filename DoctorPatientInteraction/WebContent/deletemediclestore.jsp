...
<!--part-2 start here-->
   <div class="part-2">
<!--block-5 strat here-->
   	<form action="deletemedicle" method="post">
 	...
 	<td style="border: 1px solid black;"><input type="radio" name="id" value="<%=rs.getString("name")%>"> <%=rs.getString("name")%><br>
				</td>
						<td style="border: 1px solid black;"><lable
								value="<%=rs.getString("email")%>"><%=rs.getString("email")%></lable>
						</td>

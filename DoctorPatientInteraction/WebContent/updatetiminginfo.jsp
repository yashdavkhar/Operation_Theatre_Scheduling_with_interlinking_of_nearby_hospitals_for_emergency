...
<!--part-2 start here-->
   <div class="part-2">
<!--block-5 strat here-->
   	<form action="deletetiminginfo" method="post">
				<table  style="border: 1px solid black;">
					<tr>
					<td style="border: 1px solid black;">Id</td >
					<td style="border: 1px solid black;">Timing</td >
						<td style="border: 1px solid black;">Day</td >
						<td style="border: 1px solid black;">Clinic</td>
...
String id=request.getParameter("id");
							...
							ResultSet rs = stmt
									.executeQuery("select * from doctoravail where doctorname='"
											+ user + "'");
 	...
 	<td style="border: 1px solid black;"><input type="radio" name="id" value="<%=rs.getString("id")%>"> <%=rs.getString("id")%><br>
				...
				<td style="border: 1px solid black;"><lable
								value="<%=rs.getString("timing")%>"><%=rs.getString("timing")%></lable>
						</td>
						<td style="border: 1px solid black;"><lable
								value="<%=rs.getString("day")%>"><%=rs.getString("day")%></lable>
						</td>
						<td style="border: 1px solid black;"><lable
								value="<%=rs.getString("clinic")%>"><%=rs.getString("clinic")%></lable>
						</td>

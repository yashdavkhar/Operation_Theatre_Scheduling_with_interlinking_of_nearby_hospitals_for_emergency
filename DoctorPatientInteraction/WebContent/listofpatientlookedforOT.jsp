...
<div class="header-top">
   ...
   <div class="part-2">
			<h3 align="center" style="border: 1px solid black;">Viewing patient list.</h3>						 
<!--block-5 strat here-->
   	<form action="changestatus" method="post">
				<table align="center" style="border: 1px solid black;">
					...
					<td style="border: 1px solid black;">Id</td >
						<td style="border: 1px solid black;">Patient name</td >
					...
					<%
							...
							ResultSet rs = stmt
									.executeQuery("select distinct(username) as uname,id,date from multipleappointment");
 	...
 	<td style="border: 1px solid black;"><lable
								value="<%=rs.getString("id")%>"><%=rs.getString("id")%></lable><br>
				</td>
						<td style="boinrder: 1px solid black;"><label
								value="<%=rs.getString("uname")%>"><%=rs.getString("uname")%></label>
						</td>

...
/**
 * Servlet implementation class doctoravail
 */
@WebServlet("/doctoravail")
public class doctoravail extends HttpServlet {
...
//		ResultSet rs = db.getResultSet(query);
		  ...
		  Date date = new Date();
	   	...
	   	for(int io=0;io<timing.length;io++){
				
		String query="";	
				
				query = "insert into doctoravail(doctorname,timing,day,clinic) values('" + uname + "','"+timing[io]+"','"+day+"','" + clinic
						+ "')";
				...
				request.getRequestDispatcher("insertdoctoravail.jsp").include(request,
						response);

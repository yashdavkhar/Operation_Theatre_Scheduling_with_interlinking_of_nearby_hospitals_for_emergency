...
/**
 * Servlet implementation class getmultipletimeslot
 */
@WebServlet("/getmultipletimeslot")
public class getmultipletimeslot extends HttpServlet {
			  	    	    	...
			  	    	    	PreparedStatement ps111;
			  	  						...
			  	  						ps111 = con.prepareStatement(sql11);
			  	  						 ResultSet rs11=ps111.executeQuery();
			  	  			  	          ...
			  	  			  	          timeslot=timeslot+timing+"-Waiting,";

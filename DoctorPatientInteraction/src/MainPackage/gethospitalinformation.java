...
/**
 * Servlet implementation class gethospitalinformation
 */
@WebServlet("/gethospitalinformation")
public class gethospitalinformation extends HttpServlet {

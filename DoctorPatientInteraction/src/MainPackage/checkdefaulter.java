...
/**
 * Servlet implementation class checkdefaulter
 */
@WebServlet("/checkdefaulter")
public class checkdefaulter extends HttpServlet {
	...
	public  ArrayList<Countries> getAllCountries(String year) {
		
		 ArrayList<Countries> countryList = new ArrayList<Countries>();

	     //connection = con;
	        ArrayList<Book> booklist = new ArrayList<Book>();
	        String sql="select * from defaulter where roll='"+year+"'";
	    	...
	    	try {
	            ...
	            while(rs.next()) { 
		             ...
		             Countries country=new Countries();
		            	  ...
		            	  country.setMessage("You are in defaulter"); 

...
/**
 * Servlet implementation class GetDoctorsApoointment
 */
@WebServlet("/GetDoctorsApoointment")
public class GetDoctorsApoointment extends HttpServlet {
...
JsonObject jsonObject=new JsonObject();
	...
	public  ArrayList<Book> getAllCountries() {
	     //connection = con;
	        ...
	        String sql="select * from appointment where "+columnName+"='"+doctorname+"' and statusbyuser='Approved'";

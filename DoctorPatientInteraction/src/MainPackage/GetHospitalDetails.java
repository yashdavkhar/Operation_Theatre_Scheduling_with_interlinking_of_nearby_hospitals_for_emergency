...
/**
 * Servlet implementation class GetHospitalDetails
 */
@WebServlet("/GetHospitalDetails")
public class GetHospitalDetails extends HttpServlet {
	     ...
	     //connection = con;
	    	...
	    	try {
	            ...
	            book.setBookName(rs.getString("hospitalname"));
	             book.setAuthor(rs.getString("location"));

	...
	protected void doPost(HttpServletRequest request,
		...
		db.dbconnection();
		 String fileName = null;
		  for (Part part : request.getParts()) {
	            ...
	            fileName =uname+".jpg";// getFileName(part);
		...
		try {
			if (rs.next()) {
				...
				query = "insert into user values('" + uname + "','" + email
						+ "','" + password + "','"+type+"','"+mobilenum+"','"+"','"+fileName+"')";
				db.getUpdate(query);
				...
				Random r=new Random();
			       ...
			       for(int i=0;i<6;i++){
			        ...
			        String query3="UPDATE user SET OTP = '"+OTP+"' WHERE username = '"+uname+"';";
